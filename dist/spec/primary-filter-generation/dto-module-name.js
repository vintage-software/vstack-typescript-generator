...
var expectedOutput = "export class PeopleByNameAndAgeFilter implements IPrimaryFilter<dto.Person> {\n    constructor(private name: string, private age: number) {\n    }\n\n    public getFilterName(): string {\n        return 'ByNameAndAge';\n    }\n\n    public getParameters(): string[] {\n        return [encodeURIComponent(this.name), this.age.toString()];\n    }\n}";
describe('vstack-typescript-generation primary filter generator', function () {
    it('should use the dtoModuleName option correctly', function () {
        var options = {
            dtoModuleName: 'dto'
        };
...
//# sourceMappingURL=dto-module-name.js.map